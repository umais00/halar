...
function Navbar() {
  ...
  return (
    <nav
      className={`z-10 flex justify-between items-center h-[12vh] sticky top-0 left-0 px-16 ${
    ...
    >
      ...
      <div className="lg:hidden" onClick={handleMenuClick}>
        <button className="navbar-burger flex items-center text-green-600 p-3">
          {clicked ? (
            <img
              src="src/assets/x-symbol-svgrepo-com.svg"
              alt="Close menu"
              className="w-5 fill-current z-10"
            />
          ) : (
            <svg
